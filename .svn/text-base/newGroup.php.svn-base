...
<div id = "content_wide">
  <div class = "thin">
    <form action = "<? echo $sTemplate->getRoot(); ?>i/new-group/" method = "POST" id = "form_new_group">
      <div class = "clean_box">
        <div class = "row">
      ...
      <div class = "shaded_box">
        ...
        <span class = "button_orange" style = "margin-right: 60px;" onclick = "$('#form_new_group').submit(); $(this).attr('disabled','disabled'); return false;"><? echo $sTemplate->getString("SUBMIT_NEW_GROUP"); ?></span>
        </div>
      </div>
