    ...
    <form action = "" method = "POST" id = "edit_argument">
      ...
      <div class = "shaded_box">
        <div class = "row row_submit_button">
          <button class = "button_orange" style = "margin-right: 60px;" id = "buttonSubmit" onclick = "wikiargument.submitArgument('#edit_argument', '#buttonSubmit'); return false;"><? echo $sTemplate->getString("SUBMIT_NEW_ARGUMENT"); ?></button>
        </div>
      </div>
    </form>
