...
?>
    ...
    <form action = "" method = "POST" id = "new_argument">
      ...
      <div class = "shaded_box">
        ...
        <button class = "button_orange" style = "margin-right: 60px;" id = "buttonSubmit" onclick = "wikiargument.submitArgument('#new_argument', '#buttonSubmit'); return false;"><? echo $sTemplate->getString("SUBMIT_NEW_ARGUMENT"); ?></button>
        </div>
