    ...
    <form action = "<? echo $sPage->getFormUrl(); ?>" method = "POST" id = "form_edit_question">
      ...
      <div class = "shaded_box">
        <div class = "row row_submit_button">
          <button class = "button_orange" style = "margin-right: 60px;" onclick = "$('#form_edit_question').submit(); $(this).attr('disabled','disabled'); return false;"><? echo $sTemplate->getString("SUBMIT_NEW_QUESTION"); ?></button>
        </div>
      </div>
